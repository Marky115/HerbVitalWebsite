...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2025 at 04:10 AM
...
(4, 'Inflammation and Pai', 0),
(5, 'Skin Health', 0),
(6, 'Sleep Disorders', 0),
(7, 'Cardiovascular Healt', 0),
(8, 'Detoxification and L', 0);
...
INSERT INTO `herb` (`herbID`, `herbName`, `sideEffect`, `recommendedUsage`, `Benefit`, `heatlhConcerns`) VALUES
(1, 'Peppermint', 'Possible heartburn', 'Tea or capsules', 'Helps with indigestion and bloating', 1),
(2, 'Ginger', 'Mild stomach upset', 'Tea or capsule', 'Alleviates nausea and aids digestion', 1),
(3, 'Chamomile', 'Drowsiness', 'Tea', 'Relieves indigestion and promotes relaxation', 1),
(4, 'Fennel', 'Rare allergic reactions', 'Tea or raw', 'Reduces bloating and aids digestion', 1),
